...
public class ClientReaderApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection connection = connectionFactory.open();
            ...
            channel.basicPublish(QueueNames.READ_LAST_EXCHANGE, "", null, "Read Last".getBytes(StandardCharsets.UTF_8));
            ...
            channel.basicConsume(QueueNames.READ_LAST_RESPONSE_QUEUE, true, deliverCallback, consumerTag -> {});
