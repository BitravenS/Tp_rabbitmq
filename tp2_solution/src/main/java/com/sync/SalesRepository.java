...
public class SalesRepository {
  private static final String INSERT_SQL = "INSERT IGNORE INTO product_sales (sale_date, region, product, qty, cost, amt, tax, total,"
      + " source_branch) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

  private static final String SELECT_ALL_SQL = "SELECT sale_date, region, product, qty, cost, amt, tax, total FROM product_sales WHERE"
      + " source_branch = ?";

  public void insertSale(Connection connection, ProductSales sale, String sourceBranch)
      throws SQLException {
  ...
  public List<ProductSales> fetchSalesByBranch(Connection connection, String sourceBranch)
      throws SQLException {
  ...
  public void insertSalesBatch(Connection connection, List<ProductSales> sales, String sourceBranch)
      throws SQLException {
    try (PreparedStatement stmt = connection.prepareStatement(INSERT_SQL)) {
